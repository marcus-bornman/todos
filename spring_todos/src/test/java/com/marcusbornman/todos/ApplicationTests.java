...
public class ApplicationTests {
  ...
  @Test
  public void givenExistingUser_whenUserIsReadByAuthorized_thenUserDetailsReturned()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingUser_whenUserIsReadByUnauthorized_thenUnauthorizedResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingUser_whenUserIsReadByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingUser_whenUsersIsUpdatedByAuthorized_thenUserIsUpdated()
      throws Exception {
    // Given
  ...
  @Test
  public void givenExistingUser_whenUsersIsUpdatedByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
    userRepository.save(testUser("Jane", "password123"));
  ...
  @Test
  public void givenExistingUser_whenUsersIsDeletedByAuthorized_thenNoContentResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingUser_whenUsersIsDeletedByUnAuthorized_thenUnauthorizedResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingUser_whenUsersIsDeletedByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "password123"));
    userRepository.save(testUser("Jane", "password123"));
  ...
  @Test
  public void givenValidTodoList_whenTodoListIsPostedByAuthenticated_thenTodoListCreated()
      throws Exception {
    // Given
  ...
  @Test
  public void givenInalidTodoList_whenTodoListIsPostedByAuthenticated_thenBadRequestResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "john123"));
  ...
  @Test
  public void givenNewTodoList_whenTodoListIsPostedByUnauthenticated_thenUnauthorizedResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "john123"));
    String newTodoList = "{\"title\":\"University\"}";
  ...
  @Test
  public void givenNewTodoList_whenTodoListIsPostedByDifferentUser_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("John", "john123"));
  ...
  @Test
  public void givenTodoLists_whenAllListsIsReadByAuthorized_thenRelevantListsReturned()
      throws Exception {
    // Given
  ...
  @Test
  public void givenTodoLists_whenAllListsIsReadByUnauthorized_thenUnauthorizedResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "password123"));
    User jane = userRepository.save(testUser("Jane", "password123"));
  ...
  @Test
  public void givenTodoLists_whenAllListsIsReadByDifferentUser_thenForbiddenResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "password123"));
    User jane = userRepository.save(testUser("Jane", "password123"));
  ...
  @Test
  public void givenExistingList_whenListIsUpdatedByAuthorized_thenTodoListUpdated()
      throws Exception {
    // Given
    ...
    ResultActions resultActions = mvc
        .perform(put("/api/users/John/todoLists/" + originalList.getId())
            .with(httpBasic("John", "john123"))
            .contentType(MediaType.APPLICATION_JSON)
  ...
  @Test
  public void givenExistingList_whenListIsUpdatedByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("Jane", "jane123"));
    User john = userRepository.save(testUser("John", "john123"));
  ...
  @Test
  public void givenExistingList_whenListIsDeletedByAuthorized_thenTodoListDeleted()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "john123"));
    TodoList originalList = todoListRepository.save(testTodoList("University", john));
    ...
    // When
    ResultActions resultActions = mvc
        .perform(delete("/api/users/John/todoLists/" + originalList.getId())
            .with(httpBasic("John", "john123")));
  ...
  @Test
  public void givenExistingList_whenListIsDeletedByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("Jane", "jane123"));
    User john = userRepository.save(testUser("John", "john123"));
  ...
  public void givenValidTodo_whenTodoIsPostedByAuthenticated_thenTodoCreated() throws Exception {
    ...
    // When
    ResultActions resultActions = mvc
        .perform(post("/api/users/John/todoLists/" + todoList.getId() + "/todos")
            .with(httpBasic("John", "john123"))
            .contentType(MediaType.APPLICATION_JSON)
            .content(newTodoJson));
  ...
  @Test
  public void givenInvalidTodo_whenTodoIsPostedByAuthenticated_thenBadRequestResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "john123"));
    TodoList todoList = todoListRepository.save(testTodoList("University", john));
  ...
  @Test
  public void givenValidTodo_whenTodoIsPostedByUnauthenticated_thenUnauthorizedResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "john123"));
    TodoList todoList = todoListRepository.save(testTodoList("University", john));
  ...
  @Test
  public void givenValidTodo_whenTodoIsPostedByDifferentUser_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("Jane", "jane123"));
    User john = userRepository.save(testUser("John", "john123"));
  ...
  //region TodoItem - READ

  @Test
  public void givenTodos_whenAllTodosIsReadByAuthorized_thenRelevantListReturned()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "password123"));
    User jane = userRepository.save(testUser("Jane", "password123"));
    ...
    // When
    ResultActions resultActions = mvc
        .perform(get("/api/users/John/todoLists/" + johnList.getId() + "/todos")
            .with(httpBasic("John", "password123"))
            .contentType(MediaType.APPLICATION_JSON));
  ...
  @Test
  public void givenTodos_whenAllTodosIsReadByUnauthorized_thenUnauthorizedResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "password123"));
    User jane = userRepository.save(testUser("Jane", "password123"));
  ...
  @Test
  public void givenTodos_whenAllTodosIsReadByDifferentUser_thenForbiddenResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "password123"));
    User jane = userRepository.save(testUser("Jane", "password123"));
  ...
  public void givenExistingTodo_whenTodoIsUpdatedByAuthorized_thenTodoUpdated() throws Exception {
    ...
    String updatedTodoJson =
        "{\"title\":\"Register\",\"description\":\"Register Online\",\"user\":\"/api/todoLists/"
            + todoList.getId() + "\"}";

    // When
    ResultActions resultActions = mvc.perform(
        put("/api/users/John/todoLists/" + todoList.getId() + "/todos/" + originalTodo.getId())
            .with(httpBasic("John", "password123"))
            .contentType(MediaType.APPLICATION_JSON)
  ...
  @Test
  public void givenExistingTodo_whenTodoIsUpdatedByUnauthorized_thenUnauthorizedResponse()
      throws Exception {
    // Given
    User john = userRepository.save(testUser("John", "password123"));
    TodoList todoList = todoListRepository.save(testTodoList("Personal", john));
  ...
  @Test
  public void givenExistingTodo_whenTodoIsUpdatedByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("Jane", "jane123"));
    User john = userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingTodo_whenTodoIsDeletedByUnauthorized_thenUnauthorizedResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("Jane", "jane123"));
    User john = userRepository.save(testUser("John", "password123"));
  ...
  @Test
  public void givenExistingTodo_whenTodoIsDeletedByDifferentAuthorized_thenForbiddenResponse()
      throws Exception {
    // Given
    userRepository.save(testUser("Jane", "jane123"));
    User john = userRepository.save(testUser("John", "password123"));
